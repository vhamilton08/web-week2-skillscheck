...
const arrayReverser= (arr) =>{
	...
	for(let i = arr.length; i > 0; i--){
		let reversed = arrayReverser.slice()
	}
return reversed
}
//////////////////PROBLEM 14 - 18 Setup////////////////////
...
// Code Here
myNumbersIndex = myNumbers.forEach(el => index)
//////////////////PROBLEM 18////////////////////
...
// Code Here
const totallyAwesome = people.reduce((awesomeLevel, elem) => {
	return awesomeLevel + elem
})